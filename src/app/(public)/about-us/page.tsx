...
export default function AboutUs() {
  ...
  return (
    <div className="bg-gradient-to-b from-orange-50 to-orange-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-lg text-orange-800">
            ...
            Trecolori, we believe that food is more than just sustenance—it’s an
